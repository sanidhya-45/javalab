	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==jb1) {
			...
			try{
				...
				String queryToExecute = String.format("insert into custom (custno, custname, state, creditlimit,repno) values (%d, '%s', '%s', %d, %d)", customernumber ,customername , customerstate,customercreditlimit, customerreponumber);
